...
if (isset($_POST['message_box'])) {
    ...
    if (empty($person) || empty($message)) {
        ...
        $check = "SELECT * FROM messages WHERE person = '$person'";
        $check_user = mysqli_query($conn, $check);
        $row_count = mysqli_num_rows($check_user);


            $sql = "INSERT INTO messages (person, message) VALUES ('$person', '$message')";
            if (mysqli_query($conn, $sql)) {
        ...
        <title>EduLanka</title>
            ...
            <style>
                ...
                .message-container {
                    ...
                    height: 300px; /* Set a fixed height for the message container */
...
<!--View resources-->
    ...
    <tbody>
        ...
        while ($row = mysqli_fetch_assoc($lecture_result)) {
            ...
            echo "<td><a href='delete_files.php?id=$fileId' class='btn btn-danger'>Delete</a></td>";
            echo "</tr>";
        }
    ...
    <table class="table">
        ...
        while ($info = mysqli_fetch_assoc($result)) {
            ...
            <tr class="tr">
                ...
                <td>
                    <a href="delete_quiz.php?id=<?php echo $info['id']; ?>" class="btn btn-danger btn-sm mb-3">Delete</a>
                </td>
            </tr>
            <?php
        }
