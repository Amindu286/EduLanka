...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    if (isset($_FILES['file'])) {
        ...
        if (move_uploaded_file($file, $newFilePath)) {
            ...
            $query = "INSERT INTO lecture_materials_ol (title, filename) VALUES ('$title', '$filename')";
    ...
    if (isset($_POST['sub_link'])) {
        ...
        if (empty($title) || empty($link)) {
            ...
            $sql = "INSERT INTO links_ol (title, link) VALUES ('$title', '$link')";
    ...
    if (isset($_POST['sub_quiz'])) {
        ...
        if (empty($quizno) || empty($quizlink)) {
            ...
            $sql2 = "INSERT INTO quiz_ol (quizno, quizlink) VALUES ('$quizno', '$quizlink')";
...
if (isset($_POST['message_box'])) {
    ...
    if (empty($person) || empty($message)) {
        ...
        $check = "SELECT * FROM messages_ol WHERE person = '$person'";
        $check_user = mysqli_query($conn, $check);
        $row_count = mysqli_num_rows($check_user);


            $sql = "INSERT INTO messages_ol (person, message) VALUES ('$person', '$message')";
            if (mysqli_query($conn, $sql)) {
    ...
    <div class="container-fluid">
        <a class="navbar-brand" href="#">
            <div class="d-flex align-items-center">
                ...
                <h1 class="mb-0 ml-3">Welcome to Teacher's Dashboard (GCE O/L)</h1>
            </div>
        </a>
                        ...
                        <tr>
                            <td width="50%" valign="top">
                                ...
                                <div id="chat-messages" class="message-container" style="color:red;">
                                    <?php
                                    $message_query = "SELECT * FROM messages_ol";
...
<!--View resources-->
    ...
    <tbody>
        <?php
        $lecture_query = "SELECT * FROM lecture_materials_ol";
        ...
        while ($row = mysqli_fetch_assoc($lecture_result)) {
            ...
            echo "<td><a href='delete_files_al.php?id=$fileId' class='btn btn-danger'>Delete</a></td>"; 
            echo "</tr>";
        }
...
<div class="container mt-4">
    ...
    <table class="table">
        ...
        <?php
        $selectQuery = "SELECT * FROM links_ol";
...
<div class="container mt-4">
    ...
    <table class="table">
        ...
        <?php
        $selectQuery = "SELECT * FROM quiz_ol";
        $result = mysqli_query($conn, $selectQuery);
